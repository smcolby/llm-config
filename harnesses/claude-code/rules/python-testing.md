---
description: 'Pytest conventions for Python test suites: structure, fixtures, parametrization, naming, and coverage policy. Apply when creating or modifying tests, conftest.py, or pytest configuration.'
paths:
- '**/test_*.py'
- '**/*_test.py'
- '**/tests/**'
